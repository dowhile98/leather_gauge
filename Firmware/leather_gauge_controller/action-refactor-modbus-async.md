...
* **Incremento de Baudrate:** Subir a **38400 bps**.
    * *Mejora:* El tiempo de transmisión pura baja de 15.6ms a 3.9ms por trama de 15 bytes.
    * *Resultado:* El ciclo total teórico (Tx+Rx+T3.5+Proc) baja de 330ms a **~170ms** (reducción del 48%).
